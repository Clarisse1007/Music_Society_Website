        ...
        <?php
            ...
            if ($result_readRecord->num_rows > 0) {
                ...
                if (isset($_GET['keyword'])) {
                    ...
                    $sql_search = "SELECT * FROM events WHERE event_title LIKE '%$keyword%' OR event_description LIKE '%$keyword%'";
                    $result_search = mysqli_query($mysqli, $sql_search);
                    if (!$result_search) {
